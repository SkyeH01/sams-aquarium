...
| File | Page | Job |
|---|---|---|
| `index.html` | Home | The hero, the wall of tanks, Sam's since 1985, the three-step plan, kit, reviews, calls to action |
...
The site has one voice: **a knowledgeable friend who is glad you came in.** Warm first, expert second. If a new page or a promotion is written later, these are the rules it should follow so everything still sounds like the same shop.

**1. Lead with what's good, not what goes wrong.** People act on what they want more reliably than on what they fear, and fear-framing in a small business tends to breed suspicion rather than trust. "What a good tank gives back" does the same job as "here's what happens if you get it wrong", and it leaves the reader feeling welcome.

**2. Never define the shop against somebody else.** No "not like the chain stores", no "unlike online". Say what Sam's does and let the reader draw the comparison. Watch for the "X, not Y" sentence shape in particular. The first draft of this site had sixteen of them, and each one quietly implied that somebody else gets it wrong.

**3. Offer advice, don't issue it.** "Ask us about tank size and we'll set you up for the fish it's going to become" lands very differently from "Ask us about tank size before you fall for one." Same information, no wagging finger.

**4. Don't end paragraphs on a zinger.** A punchline after every paragraph reads as smug. Let most sentences finish plainly.

**5. Say what to do rather than what to avoid.** "A light hand with the food is the easiest thing you can do for your water" rather than "overfeeding is the most common mistake we see."

**6. Vary sentence length.** Short sentences punch, longer ones carry you along, and a page of nothing but short ones sounds clipped and impatient. The home page currently averages about eleven words a sentence, with a range from four to fifty-three.
...
- **Tanks** (the framed photos) switch their light strip on as they scroll into view, flickering like a tube, one after another along a wall, and then their tape label is stuck on. Once.
